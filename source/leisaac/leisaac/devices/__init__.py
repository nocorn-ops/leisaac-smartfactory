...
if TYPE_CHECKING:
    ...
    from .keyboard import BiSO101Keyboard, SO101Keyboard
    from .lekiwi import LeKiwiGamepad, LeKiwiKeyboard, LeKiwiLeader
    from .lerobot import BiSO101Leader, SO101Leader, SO101LeaderOneArm, SO101LeaderRemote
...
_LAZY_IMPORTS = {
    ...
    "BiSO101Keyboard": (".keyboard", "BiSO101Keyboard"),
    ...
    "SO101LeaderOneArm": (".lerobot", "SO101LeaderOneArm"),
